...
| `--chart-1` to `--chart-6` | `#ffd8c2`, `#fbb088`, `#f6814f`, `#e85d30`, `#c2451f`, `#8f3417` | The six-step chart-series ramp, lightest to deepest |
...
| `max-width: 640px` | Modal padding tightens. The topbar drops its mono readout labels and the theme toggle. The dashboard grid stops being a grid: widgets stack full-width in their own height and resize handles disappear. react-grid-layout's inline transforms lose to `!important` overrides on purpose. |
