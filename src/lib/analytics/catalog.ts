...
export const DATASETS: Dataset[] = [
  ...
  // Acquisition
  { key: 'acquisition.channels', category: 'acquisition', label: 'Channels', description: 'Default channel groups: Direct, Organic Search, Referral, Social…', report: 'channel', dim: 'key1', dimLabel: 'Channel', metrics: SESSION_METRICS, defaultMetric: 'sessions', charts: RANKED, live: false },
  ...
  { key: 'acquisition.mediums', category: 'acquisition', label: 'Mediums', description: 'How a visit arrived: organic, referral, cpc, email…', report: 'source', dim: 'key2', dimLabel: 'Medium', metrics: SESSION_METRICS, defaultMetric: 'sessions', charts: RANKED, live: false },
  ...
  { key: 'content.titles', category: 'content', label: 'Page titles', description: 'The same, by page title.', report: 'page', dim: 'key2', dimLabel: 'Title', metrics: PAGE_METRICS, defaultMetric: 'pageviews', charts: RANKED, live: false },
  ...
  { key: 'audience.os', category: 'audience', label: 'Operating systems', description: 'Windows, macOS, iOS, Android…', report: 'device', dim: 'key2', dimLabel: 'OS', metrics: SESSION_METRICS, defaultMetric: 'users', charts: RANKED, live: false },
  { key: 'audience.browsers', category: 'audience', label: 'Browsers', description: 'Chrome, Safari, Firefox…', report: 'browser', dim: 'key1', dimLabel: 'Browser', metrics: SESSION_METRICS, defaultMetric: 'users', charts: RANKED, live: false },
  ...
  { key: 'audience.screens', category: 'audience', label: 'Screen resolutions', description: 'Viewport sizes (GA4 API sites only).', report: 'screen', dim: 'key1', dimLabel: 'Resolution', metrics: SESSION_METRICS, defaultMetric: 'users', charts: RANKED, live: false },
