...
export const DATASETS: Dataset[] = [
  ...
  // Acquisition
  { key: 'acquisition.channels', category: 'acquisition', label: 'Channels', description: 'Default channel groups such as Direct, Organic Search, Referral and Social.', report: 'channel', dim: 'key1', dimLabel: 'Channel', metrics: SESSION_METRICS, defaultMetric: 'sessions', charts: RANKED, live: false, drill: 'channel' },
  ...
  { key: 'acquisition.mediums', category: 'acquisition', label: 'Mediums', description: 'How a visit arrived: organic, referral, cpc, email and so on.', report: 'source', dim: 'key2', dimLabel: 'Medium', metrics: SESSION_METRICS, defaultMetric: 'sessions', charts: RANKED, live: false, drill: 'medium', keyKinds: { key1: 'source' } },
  ...
  { key: 'content.titles', category: 'content', label: 'Page titles', description: 'Pageviews and engagement by page title.', report: 'page', dim: 'key2', dimLabel: 'Title', metrics: PAGE_METRICS, defaultMetric: 'pageviews', charts: RANKED, live: false, drill: 'title', keyKinds: { key1: 'page' } },
  ...
  { key: 'audience.os', category: 'audience', label: 'Operating systems', description: 'Windows, macOS, iOS, Android and the rest.', report: 'device', dim: 'key2', dimLabel: 'OS', metrics: SESSION_METRICS, defaultMetric: 'users', charts: RANKED, live: false, drill: 'os', keyKinds: { key1: 'device' } },
  ...
  { key: 'audience.browsers', category: 'audience', label: 'Browsers', description: 'Chrome, Safari, Firefox and the rest.', report: 'browser', dim: 'key1', dimLabel: 'Browser', metrics: SESSION_METRICS, defaultMetric: 'users', charts: RANKED, live: false, drill: 'browser' },
  ...
  { key: 'audience.screens', category: 'audience', label: 'Screen resolutions', description: 'Screen sizes. GA4 API sites only, because the BigQuery export does not carry them.', report: 'screen', dim: 'key1', dimLabel: 'Resolution', metrics: SESSION_METRICS, defaultMetric: 'users', charts: RANKED, live: false, drill: 'screen' },
