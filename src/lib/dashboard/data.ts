...
import { rangeFor, segmentFor } from '@/lib/context';
 ...
 * resolves the range and the segment the way the page did, and never leaks a
 * stack trace — a widget shows a short reason instead.
 */
