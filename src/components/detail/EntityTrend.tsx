...
import { ChartFrame, ChartTip, LinkTick, SERIES, axisTick, clickedName, useHints, useNarrow, useTapToOpen } from '@/components/dashboard/chart-helpers';
      ...
      <ChartFrame clickable={!!narrow} height={220}>
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip content={<ChartTip title={fmtX} row={(v, k) => [metric.format(v), k === 'previous' ? 'Compared period' : metric.label]} hint={narrow ? hints.narrow(bucket) : null} />} />
